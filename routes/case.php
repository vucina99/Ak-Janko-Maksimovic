...
Route::group(['prefix' => 'case'], function () {
    ...
    Route::post('/get/cases/vansudski', [CaseController::class, 'getCasesVansudski']);
    ...
    Route::post('/create/case/vansudski', [CaseController::class, 'createCaseVansudski'])->middleware("adminHttp");
    ...
    Route::patch('/edit/vansudski/{id}', [CaseController::class, 'updateCaseVansudski'])->middleware("adminHttp");
